...
0
|| checktplrefresh('./template/xinyun_com_008/common/header.htm', './template/default/common/header_common.htm', 1389670496, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/xinyun_com_008', 'common/header_forum_index')
|| checktplrefresh('./template/xinyun_com_008/common/header.htm', './template/default/common/header_qmenu.htm', 1389670496, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/xinyun_com_008', 'common/header_forum_index')
;?>
...
// -->
 ...
 <!--[if IE 6]>
<script src="template/xinyun_com_008/images/iepng.js" type="text/javascript" type="text/javascript"></script> 
...
</div><?php } ?><?php echo adshow("headerbanner/wp a_h");?><div class="header">
<div style="background:url(template/xinyun_com_008/images/bg.jpg) no-repeat center top;" class="header_bg"></div>
<div class="menu png">
<div class="c">

<h1 class="logo fl2"><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></h1>
<ul class="nav lifl fr2">
<div class="login"><?php include template('common/header_userstatus'); ?></div>
<div id="nv2">
