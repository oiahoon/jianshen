...
0
|| checktplrefresh('./template/moke8_door_010/common/header.htm', './template/default/common/header_common.htm', 1390751923, '7', './data/template/7_7_common_header_forum_forumdisplay.tpl.php', './template/moke8_door_010', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/moke8_door_010/common/header.htm', './template/default/common/header_qmenu.htm', 1390751923, '7', './data/template/7_7_common_header_forum_forumdisplay.tpl.php', './template/moke8_door_010', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/moke8_door_010/common/header.htm', './template/moke8_door_010/common/pubsearchtop.htm', 1390751923, '7', './data/template/7_7_common_header_forum_forumdisplay.tpl.php', './template/moke8_door_010', 'common/header_forum_forumdisplay')
;?>
...
<?php } ?>
 <script src="template/moke8_door_010/images/jquery.min.js" type="text/javascript" ></script>
<script type="text/javascript">
  xinyunkeji = jQuery.noConflict();
//�Ժ�jquery�е�<?php echo $����xinyunkeji���漴�ɡ�;?>
xinyunkeji(function(){});
</script>
...
// -->
 ...
 <!--[if IE 6]>
<script src="template/moke8_door_010/images/iepng.js" type="text/javascript" type="text/javascript"></script> 
<script type="text/javascript">
