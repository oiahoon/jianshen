...
0
|| checktplrefresh('./template/jianshen/common/header.htm', './template/default/common/header_common.htm', 1390816266, '7', './data/template/7_7_common_header_portal_index.tpl.php', './template/jianshen', 'common/header_portal_index')
|| checktplrefresh('./template/jianshen/common/header.htm', './template/default/common/header_qmenu.htm', 1390816266, '7', './data/template/7_7_common_header_portal_index.tpl.php', './template/jianshen', 'common/header_portal_index')
|| checktplrefresh('./template/jianshen/common/header.htm', './template/jianshen/common/pubsearchtop.htm', 1390816266, '7', './data/template/7_7_common_header_portal_index.tpl.php', './template/jianshen', 'common/header_portal_index')
;?>
...
<?php } ?>
 <script src="template/jianshen/jquery.min.js" type="text/javascript" ></script>
