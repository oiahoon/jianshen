...
0
<<<<<<< HEAD
|| checktplrefresh('./template/jianshen/common/header.htm', './template/default/common/header_common.htm', 1392133005, '7', './data/template/7_7_common_header_portal_index.tpl.php', './template/jianshen', 'common/header_portal_index')
|| checktplrefresh('./template/jianshen/common/header.htm', './template/default/common/header_qmenu.htm', 1392133005, '7', './data/template/7_7_common_header_portal_index.tpl.php', './template/jianshen', 'common/header_portal_index')
|| checktplrefresh('./template/jianshen/common/header.htm', './template/jianshen/common/pubsearchtop.htm', 1392133005, '7', './data/template/7_7_common_header_portal_index.tpl.php', './template/jianshen', 'common/header_portal_index')
=======
|| checktplrefresh('./template/jianshen/common/header.htm', './template/default/common/header_common.htm', 1392197066, '7', './data/template/7_7_common_header_portal_index.tpl.php', './template/jianshen', 'common/header_portal_index')
|| checktplrefresh('./template/jianshen/common/header.htm', './template/default/common/header_qmenu.htm', 1392197066, '7', './data/template/7_7_common_header_portal_index.tpl.php', './template/jianshen', 'common/header_portal_index')
|| checktplrefresh('./template/jianshen/common/header.htm', './template/jianshen/common/pubsearchtop.htm', 1392197066, '7', './data/template/7_7_common_header_portal_index.tpl.php', './template/jianshen', 'common/header_portal_index')
...
// -->
 ...
 <!--[if IE 6]>
<script src="template/jianshen/images/iepng.js" type="text/javascript" type="text/javascript"></script> 
<script type="text/javascript">
...
.bmw, bm{ border:0px;}
.tl .th, .tl .th tr{ background:none repeat scroll 0 0 #FFFFFF;}
</style>
<?php } ?>
</head>
...
<div class="wp">
<div class="z">
                <?php $i = 1;?><?php if(is_array($_G['setting']['topnavs']['0'])) foreach($_G['setting']['topnavs']['0'] as $nav) { ?>                    
...
<div class="y">
                    <?php include template('common/header_userstatus'); ?><a id="switchblind" href="javascript:;" onClick="toggleBlind(this)" title="开启辅助访问" class="switchblind">开启辅助访问</a>
