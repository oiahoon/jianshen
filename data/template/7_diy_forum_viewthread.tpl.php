...
0
|| checktplrefresh('data/diy/./template/moke8_door_010//forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1390751961, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/moke8_door_010/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/moke8_door_010//forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1390751961, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/moke8_door_010/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/moke8_door_010//forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1390751961, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/moke8_door_010/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/moke8_door_010//forum/viewthread.htm', './template/default/common/seditor.htm', 1390751961, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/moke8_door_010/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/moke8_door_010//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1390751961, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/moke8_door_010/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/moke8_door_010//forum/viewthread.htm', './template/default/common/upload.htm', 1390751961, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/moke8_door_010/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/moke8_door_010//forum/viewthread.htm', './template/default/common/seccheck.htm', 1390751961, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/moke8_door_010/', 'forum/viewthread')
;
block_get('46,47');?><?php include template('common/header'); ?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<style id="diy_style" type="text/css">#portal_block_47 { background-color:#ffffff !important;background-image:none !important;border-top:#ffffff 10px solid !important;border-right:#ffffff 0px solid !important;border-bottom:#ffffff 10px solid !important;border-left:#e1e1e1 1px solid !important;margin-bottom:10px !important;}#portal_block_46 { background-color:#ffffff !important;background-image:none !important;border-top:#ffffff 10px solid !important;border-right:#ffffff 10px solid !important;border-bottom:#ffffff 2px solid !important;border-left:#ffffff 10px solid !important;margin-bottom:10px !important;}#portal_block_46 .dxb_bc { margin:0px !important;}#frameCg6oWO { background-color:#ffffff !important;background-image:none !important;margin-bottom:10px !important;}#portal_block_47 .dxb_bc { margin-left:10px !important;}</style>
...
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frameCg6oWO" class=" frame move-span cl frame-3-1"><div id="frameCg6oWO_left" class="column frame-3-1-l"><div id="frameCg6oWO_left_temp" class="move-span temp"></div><?php block_display('46');?></div><div id="frameCg6oWO_center" class="column frame-3-1-r"><div id="frameCg6oWO_center_temp" class="move-span temp"></div><?php block_display('47');?></div></div></div><!--[/diy]-->
</div>
