...
0
|| checktplrefresh('data/diy/./template/jianshen//forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1391764296, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/jianshen/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/jianshen//forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1391764296, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/jianshen/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/jianshen//forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1391764296, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/jianshen/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/jianshen//forum/viewthread.htm', './template/default/common/seditor.htm', 1391764296, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/jianshen/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/jianshen//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1391764296, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/jianshen/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/jianshen//forum/viewthread.htm', './template/default/common/upload.htm', 1391764296, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/jianshen/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/jianshen//forum/viewthread.htm', './template/default/common/seccheck.htm', 1391764296, 'diy', './data/template/7_diy_forum_viewthread.tpl.php', 'data/diy/./template/jianshen/', 'forum/viewthread')
;
block_get('140,141');?><?php include template('common/header'); ?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<style id="diy_style" type="text/css">#frameX3439r {  background-color:#ffffff !important;background-image:none !important;margin-bottom:10px !important;}#portal_block_141 {  background-color:#ffffff !important;background-image:none !important;border-top:#ffffff 10px solid !important;border-right:#ffffff 0px solid !important;border-bottom:#ffffff 10px solid !important;border-left:#e1e1e1 1px solid !important;margin-bottom:10px !important;}#portal_block_140 {  background-color:#ffffff !important;background-image:none !important;border-top:#ffffff 10px solid !important;border-right:#ffffff 10px solid !important;border-bottom:#ffffff 2px solid !important;border-left:#ffffff 10px solid !important;margin-bottom:10px !important;}#portal_block_140 .dxb_bc {  margin:0px !important;}#frameZaqnI7 {  background-color:#ffffff !important;background-image:none !important;margin-bottom:10px !important;}#portal_block_141 .dxb_bc {  margin-left:10px !important;}</style>
...
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frameZaqnI7" class=" frame move-span cl frame-3-1"><div id="frameZaqnI7_left" class="column frame-3-1-l"><div id="frameZaqnI7_left_temp" class="move-span temp"></div><?php block_display('140');?></div><div id="frameZaqnI7_center" class="column frame-3-1-r"><div id="frameZaqnI7_center_temp" class="move-span temp"></div><?php block_display('141');?></div></div><div id="frameX3439r" class=" frame move-span cl frame-3-1"><div id="frameX3439r_left" class="column frame-3-1-l"><div id="frameX3439r_left_temp" class="move-span temp"></div></div><div id="frameX3439r_center" class="column frame-3-1-r"><div id="frameX3439r_center_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>
