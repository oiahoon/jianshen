...
if(!submitcheck('settingsubmit')) {
  ...
  if($operation == 'basic') {
    ...
    showsetting('setting_basic_site_phone', 'settingnew[site_phone]', $setting['site_phone'], 'text');
    ...
    showsetting('setting_basic_site_weibo', 'settingnew[site_weibo]', $setting['site_weibo'], 'text');
    showsetting('setting_basic_site_weixin', 'settingnew[site_weixin]', $setting['site_weixin'], 'text');
    showsetting('setting_basic_site_xinxi', 'settingnew[site_xinxi]', $setting['site_xinxi'], 'text');
