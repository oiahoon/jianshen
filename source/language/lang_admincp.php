...
(
  ...
  'setting_basic_site_phone' => '咨询热线',
  'setting_basic_site_phone_comment' => '首页显示咨询热线电话号码',
  'setting_basic_site_weibo' => '会友微博地址',
  'setting_basic_site_weibo_comment' => '首页显示微博图标，在此输入您的微博链接，它将引导用户关注您的微博',
  'setting_basic_site_weixin' => '会友微信链接',
  'setting_basic_site_weixin_comment' => '首页显示微信图标，在此输入您的微信链接，它将引导用户关注您的微信',
  'setting_basic_site_xinxi' => '会友信息链接',
  'setting_basic_site_xinxi_comment' => '首页显示信息图标，在此输入您想要设置的信息链接，它将带领用户查看信息',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
  ...
  'misc_link_group1' => '品牌合作<br/><font color="red">需要图标</font>',
  'misc_link_group2' => '普通分组2',
  'misc_link_group3' => '普通分组3',
  'misc_link_group4' => '普通分组4',
  'misc_link' => '友情链接',
