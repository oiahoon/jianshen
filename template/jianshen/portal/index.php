  ...
  <div class="denglubox">
    ...
    <!--{if $_G['uid']}-->
      ...
      <div class="quickico1">
        ...
        $_G[group][grouptitle]<br />
        <!--{loop $_G[setting][extcredits] $id $credit}-->
          <em>$credit[title]: <!--{eval echo getuserprofile('extcredits'.$id);}--></em>
        <!--{/loop}-->
    ...
    <!--{else}-->
      ...
      <div class="quickico1">
        <a class="misscode" href="member.php?mod={$_G[setting][regname]}">$_G[setting][reglinkname]</a><br />
        <a class="zc"> <a href="member.php?mod=logging&action=login" onclick="showWindow('login', this.href)">{lang login}</a>
      </div>
    <!--{/if}-->
    </div>
     <div class="quickico2">
